...
import bgImg from "../../../assets/images/applicant-imgs/trees-bg-header-applicants.webp"
import headerImg from "../../../assets/images/applicant-imgs/snowy-bg-applicants.webp"
  ...
  return (
    <>
      ...
      <div
        className=""
        style={{
          background: `linear-gradient(rgba(255, 255, 255, 0.95), rgba(255, 255, 255, 0.8), rgba(255, 255, 255, 0.75)), url(${headerImg})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
